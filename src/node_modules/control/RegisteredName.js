...
import "control/RegisteredName.css";
...
export const RegisteredName = ({ name, generation, latest, verified, correct }) => {
    if (!name) {
        return null;
    }
    ...
    return (
        <span className={klass}>
            {name}
            <NameGeneration generation={generation} latest={latest} />
        </span>
    );
};
