...
import { TIMELINE_FUTURE_SLICE_LOAD, TIMELINE_PAST_SLICE_LOAD } from "state/timeline/actions";
import { POSTING_LOAD } from "state/posting/actions";
...
import posting from "state/posting/reducer";
...
import { timelineFutureSliceLoadSaga, timelinePastSliceLoadSaga } from "state/timeline/sagas";
import { postingLoadSaga } from "state/posting/sagas";
...
import postingTriggers from "state/posting/triggers";
...
function* combinedSaga() {
    ...
    yield takeLatest(POSTING_LOAD, postingLoadSaga);
