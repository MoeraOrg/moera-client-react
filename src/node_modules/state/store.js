import { INIT_FROM_LOCATION, UPDATE_LOCATION } from "state/navigation/actions";
...
import { initFromLocationSaga, updateLocationSaga } from "state/navigation/sagas";
...
const triggers = collectTriggers(homeTriggers, navigationTriggers, ownerTriggers, profileTriggers);
...
export default createStore(
    combineReducers({ error, naming, node, home, tokens, navigation, connectDialog, owner, profile, messageBox }),
