import { PAGE_COMPOSE, PAGE_POSTING, PAGE_PROFILE, PAGE_TIMELINE } from "state/navigation/pages";
...
export const goToPosting = (id) => goToPage(PAGE_POSTING, {id});
export const goToCompose = () => goToPage(PAGE_COMPOSE);
...
export const SCROLL_LOCATION = "SCROLL_LOCATION";
