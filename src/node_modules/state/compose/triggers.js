...
export default [
    ...
    trigger(EVENT_HOME_NODE_SETTINGS_CHANGED, isAtComposePage, composeFeaturesLoad),
    trigger(EVENT_HOME_NODE_SETTINGS_CHANGED, inv(isAtComposePage), composeFeaturesUnset)
];
