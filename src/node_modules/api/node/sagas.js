...
import { formatSchemaErrors, NodeApiError, NodeError } from "api/error";
...
export function* putProfile(profile) {
    ...
    const location =  "/profile?token=" + encodeURIComponent(token);
    return yield call(callNode, {location, method: "PUT", body: profile, schema: NodeApi.Result});
}
