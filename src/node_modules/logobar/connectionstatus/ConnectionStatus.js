...
import { Popover } from "control/Popover";
...
const ConnectionStatus = ({connecting,  connected, location, login, openConnectDialog, disconnectFromHome}) => (
    <>
            ...
            :
                ...
                :
                    <>
                        ...
                        {" "}to home
                        <Button variant="outline-primary" onClick={disconnectFromHome}>Disconnect</Button>
                    </>
            )
        }</div>
        <ConnectDialog />
