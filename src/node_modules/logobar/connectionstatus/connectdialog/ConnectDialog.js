...
const ConnectDialog = ({show, location, login, cancelConnectDialog}) => (
    show &&
        <Formik initialValues={{location, login}}>
            <Form>
                <div className="modal-backdrop fade show" />
                <div className="modal fade show" style={{display: "block"}} onClick={cancelConnectDialog}>
