...
const settingsSheetOtherLogic = {
    ...
    mapPropsToValues(props) {
        const {nodeValues, nodeMeta, loadedNodeValues, loadedNodeMeta} = props;

        if (!loadedNodeValues || !loadedNodeMeta) {
            return {};
        }
...
export default connect(
    state => ({
        loadedNodeValues: state.settings.node.loadedValues,
        loadedNodeMeta: state.settings.node.loadedMeta,
