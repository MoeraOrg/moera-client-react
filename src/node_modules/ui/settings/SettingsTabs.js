...
const SettingsTabs = ({loadingNodeValues, loadingNodeMeta, loadingClientValues}) => (
    <ul className="nav nav-tabs settings-tabs">
        <SettingsTab name="node" title="Node" href={"/settings/node"} loading={loadingNodeValues || loadingNodeMeta}/>
        <SettingsTab name="client" title="Client" href={"/settings/client"} loading={loadingClientValues}/>
    </ul>
);
