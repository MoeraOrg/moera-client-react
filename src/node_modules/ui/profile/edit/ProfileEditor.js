...
const profileEditorLogic = {
    ...
    validationSchema: yup.object().shape({
        fullName: yup.string().max(255, "Too long"),
        gender: yup.string().max(31, "Too long"),
        email: yup.string().max(63, "Too long").email("Must be a valid e-mail")
    }),
