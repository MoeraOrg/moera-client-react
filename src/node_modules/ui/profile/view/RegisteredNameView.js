...
import { registeredNameUpdateDialog, registerNameDialog } from "state/registeredname/actions";
...
import RegisteredNameUpdateDialog from "ui/profile/manage/RegisteredNameUpdateDialog";

const ManagementButtonsImpl = ({nameDefined, operationPending, registerNameDialog, registeredNameUpdateDialog}) => (
    <div className="col-sm-9">
        <Button variant="outline-secondary" size="sm" disabled={operationPending}
                onClick={e => registeredNameUpdateDialog(true)}>
            Change
        </Button>
        ...
        {nameDefined &&
            <Button variant="primary" size="sm" disabled={operationPending} style={{marginLeft: "0.2rem"}}
                    onClick={e => registeredNameUpdateDialog(false)}>
                Prolong
            </Button>
        }
    </div>
...
const ManagementButtons = connect(
    ...
    { registerNameDialog, registeredNameUpdateDialog }
)(ManagementButtonsImpl);

const RegisteredNameView = ({loading, name, manageable}) => (
    <>
        <h4>
        ...
        <div className="row">
            {name &&
                <div className="col-sm-3">
                    <RegisteredName name={name} linked={false}/>
