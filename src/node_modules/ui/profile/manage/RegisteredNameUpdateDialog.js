...
const registeredNameUpdateDialogLogic = {
    ...
    validationSchema(props) {
        const mnemonic = yup.array().min(24).max(24).of(yup.string().required("Must not be empty").trim()
        ...
        return props.showChangeName
            ? yup.object().shape({
                ...
                generation: yup.number().required("Must not be empty").positive("Must be 0 or greater"),
                mnemonic
            })
            : yup.object().shape({
                mnemonic
    ...
    handleSubmit(values, formik) {
        ...
        formik.props.registeredNameUpdateDialogCancel();
