        ...
        return (
            <ModalDialog onClose={onCancel}>
                <div className="modal-body">
                    ...
                    <ReactionSelector negative={negative} reactions={this.getMainReactions()} onClick={this.onClick}/>
                    {additionalReactions.length > 0 &&
                        <>
                            <h5 className="mt-3">Additional</h5>
                            <ReactionSelector negative={negative} reactions={additionalReactions}
