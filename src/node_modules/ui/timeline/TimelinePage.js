...
class TimelinePage extends React.Component {
    ...
    static getTopmostMoment() {
        ...
        const top = mainMenu != null && header != null
    ...
    scrollTo(moment) {
        ...
        if (posting != null) {
            ...
            const mainMenu = document.getElementById("main-menu");
            const header = document.getElementById("timeline-header");
            if (mainMenu != null && header != null) {
                const y = -mainMenu.getBoundingClientRect().height - header.getBoundingClientRect().height - 10;
                window.scrollBy(0, y);
            }
        }
        this.prevAt = moment;
    ...
    render() {
        const {loadingFuture, loadingPast, postings, before, after} = this.props;
