...
class TimelinePage extends React.Component {
    ...
    constructor(props) {
        ...
        this.observerFuture = new IntersectionObserver(this.onSentinelFuture, {rootMargin: "250px 0px 0px 0px"});
        ...
        this.observerPast = new IntersectionObserver(this.onSentinelPast, {rootMargin: "0px 0px 250px 0px"});
    }
    ...
    scrollToAnchor() {
        if (this.newAnchor != null && this.newAnchor <= this.props.before && this.newAnchor > this.props.after) {
            TimelinePage.scrollTo(this.newAnchor);
            this.newAnchor = null;
        }
    }
