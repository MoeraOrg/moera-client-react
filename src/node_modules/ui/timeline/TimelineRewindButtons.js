...
import "./TimelineRewindButtons.css";
...
class TimelineRewindButtons extends React.PureComponent {
    ...
    render() {
        return (
            <>
                <div className="timeline-rewind-btn">
                    <button className={
                        cx(["btn", "btn-outline-info", "btn-sm", {"invisible": this.isAtTop()}])
                    } onClick={this.toTop}>&#x23f6;&nbsp;Top</button>
                </div>
                <div className="timeline-rewind-btn">
                    <button className={
                        cx(["btn", "btn-outline-info", "btn-sm", {"invisible": this.isAtBottom()}])
                    } onClick={this.toBottom}>&#x23f7;&nbsp;Bottom</button>
                </div>
            </>
        );
    }
