...
const Content = ({posting, href, onClick}) => {
    if (posting.bodyPreview) {
        return (
            <div className="content">
                <div dangerouslySetInnerHTML={{__html: posting.bodyPreview}} />
                <a href={href} onClick={onClick}>Continue Reading &rarr;</a>
            </div>
        );
    } else {
        return (
            <div className="content" dangerouslySetInnerHTML={{__html: posting.body}} />
        );
    }
};
...
class TimelinePosting extends React.PureComponent {
    ...
    render() {
        const {posting, deleting, isPermitted, rootLocation} = this.props;
