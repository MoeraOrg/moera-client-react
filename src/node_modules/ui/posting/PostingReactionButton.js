...
import { ReactionSelector } from "ui/control";
...
class PostingReactionButton extends React.PureComponent {
    ...
    initReactions() {
        ...
        return main.concat(additionalNode, additionalClient);
    }
                            ...
                            {({ref, style, placement}) => (
                                <div ref={ref} style={style} className={cx(
                                    ...
                                    <div className="popover-body" onMouseEnter={this.popupEnter}
                                        ...
                                        <ReactionSelector negative={negative} reactions={this.state.reactions}
                                                    fixedWidth={true}
