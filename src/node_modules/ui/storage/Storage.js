...
class Storage extends React.Component {
    ...
    loadedData(data) {
        ...
        let {location, login, token, permissions, cartes} = data.home;
        cartes = cartes != null ? JSON.parse(cartes) : null;
        if (location != null || login != null || token != null || permissions != null) {
            this.props.homeRestore(location, login, token, permissions, cartes);
        } else {
            this.props.cartesSet(cartes);
        }
    }
