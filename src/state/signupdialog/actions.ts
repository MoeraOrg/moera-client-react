...
type OpenSignUpDialogAction = ActionBase<typeof OPEN_SIGN_UP_DIALOG, never>;
...
type CancelSignUpDialogAction = ActionBase<typeof CANCEL_SIGN_UP_DIALOG, never>;
export const cancelSignUpDialog = (): CancelSignUpDialogAction => ({
    type: CANCEL_SIGN_UP_DIALOG
});

export const SIGN_UP = "SIGN_UP";
type SignUpAction = ActionBase<typeof SIGN_UP, {
    provider: string;
    name: string;
    domain: string;
    password: string;
...
type SignedUpAction = ActionBase<typeof SIGNED_UP, never>;
export const signedUp = (): SignedUpAction => ({
    type: SIGNED_UP
});

export const SIGN_UP_FAILED = "SIGN_UP_FAILED";
type SignUpFailedAction = ActionBase<typeof SIGN_UP_FAILED, {
    stage: SignUpStage;
}>;
...
type SignUpNameVerifyAction = ActionBase<typeof SIGN_UP_NAME_VERIFY, {
    name: string;
    onVerify: any;
}>;
...
type SignUpFindDomainAction = ActionBase<typeof SIGN_UP_FIND_DOMAIN, {
    provider: string;
    name: string;
    onFound: any;
}>;
...
type SignUpDomainVerifyAction = ActionBase<typeof SIGN_UP_DOMAIN_VERIFY, {
    provider: string;
    name: string;
    onVerify: any;
}>;
