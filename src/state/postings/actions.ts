...
export const postingDeleted = (
    id: string, feedReferences: FeedReference[], nodeName: string
...
export const postingOperationsUpdate = (
    id: string, nodeName: string, operations: PostingOperations
...
export const postingReact = (
    id: string, negative: boolean, emoji: number, nodeName: string
): PostingReactAction =>
...
export const postingReactionSet = (
    id: string, reaction: ReactionAttributes | null, totals: ReactionTotalsInfo, nodeName: string
...
export const postingCommentsSubscribed = (
    id: string, subscriptionId: string, nodeName: string
...
export const postingCommentsSubscribeFailed = (id: string, nodeName: string): PostingCommentsSubscribeFailedAction =>
...
export const postingSubscriptionSet = (
    id: string, type: SubscriptionType, subscriptionId: string | null, nodeName: string
...
export const postingCommentAddedBlocked = (
    id: string, blockedInstantId: string, nodeName: string
...
export const postingCommentAddedBlockFailed = (id: string, nodeName: string): PostingCommentAddedBlockFailedAction =>
...
export const postingCommentAddedUnblocked = (id: string, nodeName: string): PostingCommentAddedUnblockedAction =>
