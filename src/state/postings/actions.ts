...
type PostingSetAction = ActionBase<typeof POSTING_SET, {
    posting: PostingInfo;
}>;
...
type PostingDeleteAction = ActionBase<typeof POSTING_DELETE, {
    id: string;
}>;
...
type PostingDeletedAction = ActionBase<typeof POSTING_DELETED, {
    id: string;
...
type PostingDeleteFailedAction = ActionBase<typeof POSTING_DELETE_FAILED, {
    id: string;
}>;
...
type PostingLoadAction = ActionBase<typeof POSTING_LOAD, {
    id: string;
}>;
...
type PostingLoadFailedAction = ActionBase<typeof POSTING_LOAD_FAILED, {
    id: string;
}>;
...
type PostingVerifyAction = ActionBase<typeof POSTING_VERIFY, {
    id: string;
}>;
...
type PostingVerifyFailedAction = ActionBase<typeof POSTING_VERIFY_FAILED, {
    id: string;
}>;
...
type PostingReactAction = ActionBase<typeof POSTING_REACT, {
    id: string;
    negative: boolean;
    emoji: number;
}>;
...
type PostingReactionLoadAction = ActionBase<typeof POSTING_REACTION_LOAD, {
    id: string;
}>;
...
type PostingReactionDeleteAction = ActionBase<typeof POSTING_REACTION_DELETE, {
    id: string;
}>;
...
type PostingReactionSetAction = ActionBase<typeof POSTING_REACTION_SET, {
    id: string;
...
type PostingCopyLinkAction = ActionBase<typeof POSTING_COPY_LINK, {
    id: string;
}>;
...
type PostingCommentsSetAction = ActionBase<typeof POSTING_COMMENTS_SET, {
    id: string;
    total: number;
}>;
...
type PostingCommentsSubscribeAction = ActionBase<typeof POSTING_COMMENTS_SUBSCRIBE, {
    id: string;
}>;
...
type PostingCommentsSubscribedAction = ActionBase<typeof POSTING_COMMENTS_SUBSCRIBED, {
    id: string;
    subscriberId: string;
}>;
...
type PostingCommentsSubscribeFailedAction = ActionBase<typeof POSTING_COMMENTS_SUBSCRIBE_FAILED, {
    id: string;
}>;
...
type PostingCommentsUnsubscribeAction = ActionBase<typeof POSTING_COMMENTS_UNSUBSCRIBE, {
    id: string;
    subscriberId: string;
}>;
...
type PostingCommentsUnsubscribedAction = ActionBase<typeof POSTING_COMMENTS_UNSUBSCRIBED, {
    id: string;
}>;
...
type PostingCommentsUnsubscribeFailedAction = ActionBase<typeof POSTING_COMMENTS_UNSUBSCRIBE_FAILED, {
    id: string;
}>;
...
type PostingSubscriptionSetAction = ActionBase<typeof POSTING_SUBSCRIPTION_SET, {
    id: string;
...
type RemotePostingSubscriptionSetAction = ActionBase<typeof REMOTE_POSTING_SUBSCRIPTION_SET, {
