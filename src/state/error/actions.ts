...
type ErrorThrownAction = ActionBase<typeof ERROR_THROWN, {
    e: Error
}>;
...
type ErrorShowAction = ActionBase<typeof ERROR_SHOW, {
    message: string;
...
type ErrorDismissAction = ActionBase<typeof ERROR_DISMISS, never>;
export const errorDismiss = (): ErrorDismissAction => ({
    type: ERROR_DISMISS
});

export const ERROR_AUTH_INVALID = "ERROR_AUTH_INVALID";
type ErrorAuthInvalidAction = ActionBase<typeof ERROR_AUTH_INVALID, never>;
