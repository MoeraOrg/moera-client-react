...
export default [
    ...
    trigger("HOME_READY", conj(isAtPeoplePage, isAtFriendOfsTab), friendOfsLoad),
    trigger("HOME_READY", conj(isAtPeoplePage, isAtBlockedTab), blockedLoad),
    trigger("HOME_READY", conj(isAtPeoplePage, isAtBlockedByTab), blockedByLoad),
    trigger(
