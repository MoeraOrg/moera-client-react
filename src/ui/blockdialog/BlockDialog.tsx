            ...
            <Form>
                <div className="modal-body">
                    ...
                    <div className="unblock-days">
                        <CheckboxField name="temporary" title={values.temporary ? undefined : t("unblock-after-time")}
                                       anyValue/>
                        {values.temporary &&
...
const blockDialogLogic = {
    ...
    handleSubmit(values: Values, formik: FormikBag<OuterProps, Values>): void {
        ...
        formik.props.blockDialogSubmit(formik.props.nodeName, prev, BLOCKED_OPERATIONS[values.level], deadline);
