...
const MENU_ITEMS: Record<SettingsTabId, Sheet[]> = {
    ...
    "client": [
        sheet("appearance", [
            ...
            option(CLIENT_SETTINGS_PREFIX + "posting.body.font-magnitude.mobile"),
            ...
            option(CLIENT_SETTINGS_PREFIX + "explore.news.show"),
        ]),
        sheet("notifications", [
        ...
        sheet("posting", [
            ...
            chapter("comments", null, [
                ...
                option(CLIENT_SETTINGS_PREFIX + "posting.comments.addition.default", 0),
                option(CLIENT_SETTINGS_PREFIX + "posting.comments.trust.default", 2),
